...
shinyUI(fluidPage(
  ...
  # Application title
titlePanel("Example Population shiny app"),
      ...
      #
        navlistPanel(
                    tabPanel("Population Data", 
                             ...
                             HTML("<h1> Write a short title here</h1>
        <p>Say something sensible about the project you are doing.  Explain the project in a paragraph.   To use this as part of a job portfolio, include a picture of yourself.  </p>
		<p>Make a new paragraph to say something about yourself. Use html code to make links to things like your LinkedIn, Twitter, Github, etc page.  Keep your code very basic to avoid breaking things.  Feel free to modify this template. It is very useful for building a portfolio of projects and skills. Although this paragraph can be very basic , adding those elements in now will save you time when you are job hunting for a career or co-op job. </p>"
                             ),plotOutput("PopPlot")),
                    tabPanel("More", plotOutput("PlotPlot")),
